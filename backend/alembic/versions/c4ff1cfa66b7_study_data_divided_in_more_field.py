...
def upgrade() -> None:
    ...
    op.add_column(
        "studies",
        sa.Column("study_data_address", sa.String, nullable=False, server_default=""),
    )
    op.add_column(
        "studies",
        sa.Column("study_data_contact", sa.String, nullable=False, server_default=""),
    )
    op.add_column(
        "studies",
...
def downgrade() -> None:
    op.add_column(
        "studies",
        sa.Column("consent_study_data", sa.String, nullable=False, server_default=""),
    )
